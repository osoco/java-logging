...
class ElasticSearchEnvVarIsConfiguredSpecification extends Specification {

    def "The LoggingConfigurationRegistry finds the ElasticSearchConfiguration if the environment variables are found" () {
        setup:
        LoggingConfigurationRegistry.getInstance().clean()
        def orig = System.metaClass.static.getProperty
        ...
        cleanup:
        System.metaClass.static.getProperty = orig
    }
}
